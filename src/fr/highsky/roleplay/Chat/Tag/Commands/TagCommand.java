package fr.highsky.roleplay.Chat.Tag.Commands;
        ...
        if (args.length == 3) {
            if (args[0].equalsIgnoreCase("give")) {
                ...
                if(!args[1].isEmpty() && !args[2].isEmpty()){
                    ...
                    if(p.isOnline() && !Main.mapTAG.containsKey(p.getUniqueId())){
                        Main.mapTAG.put(p.getUniqueId(), args[2]);
                    }else{
                        Main.mapTAG.replace(p.getUniqueId(), args[2]);
                    }
                }
            }
